<style>
	/* Define styles for the w3view-cart class */
.w3view-cart {
    display: inline-block;
    background-color: #f31f1f; /* Background color for the link */
...
/* Hover state: Change background color on hover */
.w3view-cart:hover {
    background-color: #1accfd; /* New background color on hover */
	 color: #fff; /* Text color */
}
...
<div class="header-bot">
		...
		<form action="{{ url('cart') }}" method="post" class="last">
    <input type="hidden" name="cmd" value="_cart">
    <input type="hidden" name="display" value="1">
    @if(Route::has('login'))
        @auth
            {{-- Only authenticated users can view the cart --}}
            {{-- <button class="w3view-cart" type="submit" name="submit" value=""> --}}
				<a href="{{ url('cart')  }}" class="w3view-cart">
				 <i class="fa fa-cart-arrow-down" aria-hidden="true"></i> View Cart</a>
               
            {{-- </button> --}}
        @else
            {{-- Show a message or a link to login for guests --}}
            <p>Please <a href="{{ route('login') }}">log in</a> to view your cart.</p>
        @endauth
    @endif
</form>
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu multi-column columns-3">
										<div class="agile_inner_drop_nav_info">
											...
											<div class="col-sm-4 multi-gd-img">
												<img src="user/images/nav.png" alt="">
											</div>
											<div class="clearfix"></div>
										</div>
									</ul>
