...
<html
  ...
  data-assets-path="new_admin/assets/"
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="new_admin/assets/img/favicon/favicon.ico" />
    ...
    <link rel="stylesheet" href="new_admin/assets/vendor/fonts/materialdesignicons.css" />

    <!-- Menu waves for no-customizer fix -->
    <link rel="stylesheet" href="new_admin/assets/vendor/libs/node-waves/node-waves.css" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="new_admin/assets/vendor/css/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="new_admin/assets/vendor/css/theme-default.css" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="new_admin/assets/css/demo.css" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="new_admin/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
    <link rel="stylesheet" href="new_admin/assets/vendor/libs/apex-charts/apex-charts.css" />

    <!-- Page CSS -->

    <!-- Helpers -->
    <script src="new_admin/assets/vendor/js/helpers.js"></script>
    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
    <script src="new_admin/assets/js/config.js"></script>
  </head>
  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <div class="layout-page">
         ...
         @include('admin.New_admin.include.navbar')
          ...
          @yield('content')
            ...
            <!-- Footer -->
           @include('admin.New_admin.include.footer')
            <!-- / Footer -->
    ...
    <script src="new_admin/assets/vendor/libs/jquery/jquery.js"></script>
    <script src="new_admin/assets/vendor/libs/popper/popper.js"></script>
    <script src="new_admin/assets/vendor/js/bootstrap.js"></script>
    <script src="new_admin/assets/vendor/libs/node-waves/node-waves.js"></script>
    <script src="new_admin/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
    <script src="new_admin/assets/vendor/js/menu.js"></script>

    <!-- endbuild -->

    <!-- Vendors JS -->
    <script src="new_admin/assets/vendor/libs/apex-charts/apexcharts.js"></script>

    <!-- Main JS -->
    <script src="new_admin/assets/js/main.js"></script>

    <!-- Page JS -->
    <script src="new_admin/assets/js/dashboards-analytics.js"></script>
