              ...
              <div class="row gy-4">
                ...
                <div class="col-md-12 col-lg-4">
                  <div class="card">
                    ...
                    <img
                      src="new_admin/assets/img/icons/misc/triangle-light.png"
                    ...
                    <img
                      src="new_admin/assets/img/illustrations/trophy.png"
                      ...
                      <ul class="p-0 m-0">
                        <li class="d-flex mb-4 pb-md-2">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="new_admin/assets/img/icons/misc/zipcar.png" alt="zipcar" class="rounded" />
                          </div>
                        ...
                        <li class="d-flex mb-4 pb-md-2">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="new_admin/assets/img/icons/misc/bitbank.png" alt="bitbank" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex mb-md-3">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="new_admin/assets/img/icons/misc/aviato.png" alt="aviato" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                          ...
                          <ul class="p-0 m-0">
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-3">
                                <img
                                  src="new_admin/assets/img/icons/payments/gumroad.png"
                                  class="img-fluid"
                                  alt="gumroad"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-3">
                                <img
                                  src="new_admin/assets/img/icons/payments/mastercard-2.png"
                                  class="img-fluid"
                                  alt="mastercard"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-3">
                                <img
                                  src="new_admin/assets/img/icons/payments/stripes.png"
                                  class="img-fluid"
                                  alt="stripes"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-3">
                                <img
                                  src="new_admin/assets/img/icons/payments/american-bank.png"
                                  class="img-fluid"
                                  alt="american"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex align-items-center">
                              <div class="flex-shrink-0 me-3">
                                <img
                                  src="new_admin/assets/img/icons/payments/citi.png"
                                  class="img-fluid"
                                  alt="citi"
                                  height="30"
                                  width="30" />
                        ...
                        <div class="pt-2">
                          <ul class="p-0 m-0">
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-3">
                                <img
                                  src="new_admin/assets/img/icons/brands/google.png"
                                  class="img-fluid"
                                  alt="google"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-3">
                                <img
                                  src="new_admin/assets/img/icons/brands/github.png"
                                  class="img-fluid"
                                  alt="github"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-3">
                                <img
                                  src="new_admin/assets/img/icons/brands/slack.png"
                                  class="img-fluid"
                                  alt="slack"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-3">
                                <img
                                  src="new_admin/assets/img/icons/payments/digital-ocean.png"
                                  class="img-fluid"
                                  alt="digital"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex align-items-center">
                              <div class="flex-shrink-0 me-3">
                                <img
                                  src="new_admin/assets/img/icons/brands/aws.png"
                                  class="img-fluid"
                                  alt="aws"
                                  height="30"
                                  width="30" />
                        ...
                        <tbody>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-3">
                                  <img src="new_admin/assets/img/avatars/1.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-3">
                                  <img src="new_admin/assets/img/avatars/3.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-3">
                                  <img src="new_admin/assets/img/avatars/2.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-3">
                                  <img src="new_admin/assets/img/avatars/5.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-3">
                                  <img src="new_admin/assets/img/avatars/4.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-3">
                                  <img src="new_admin/assets/img/avatars/7.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-3">
                                  <img src="new_admin/assets/img/avatars/6.png" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
